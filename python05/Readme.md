...
*Focuses on method overriding and subtype polymorphism*

## Usage 

Execute **python3 main.py** to verify your polymorphic constructs are achieving consciousness.

## Guidelines
### Standards
• Your project must be written in **Python 3.10 or later**.
• Your project must adhere to the **flake8** coding standard.
• **All code must include comprehensive type annotations** using the typing
module.
