...
class Plant:
    ...
    def get_info(self):
        ...
        return f"{self.get_name()} ({self.__class__.__name__}): " + content
...
class Vegetable(Plant):
    ...
    def nutritional_value(self):
        return f"{self.get_name()} is rich in vitamin C"
...
p3 = Vegetable("Tomato", 80, 90, "summer")
